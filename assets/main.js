...
const showDetailsCocktail = () => {
  const img = document.querySelector('#ptu-img');
  img.classList.toggle('open');
  const details = document.querySelector('#ptu-details');
  details.classList.toggle('active');
};

const openCocktailImage = document.querySelector('#ptu-img');
const openCocktailImageX = document.querySelector('#ptu-more');
